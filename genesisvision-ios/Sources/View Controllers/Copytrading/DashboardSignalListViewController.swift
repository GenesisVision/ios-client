...
class DashboardSignalListViewController: BaseViewControllerWithTableView {
...
extension DashboardSignalListViewController {
...
extension DashboardSignalListViewController: UIViewControllerPreviewingDelegate {
...
extension DashboardSignalListViewController: ReloadDataProtocol {
    func didReloadData() {
        reloadData()
    }
}
...
extension DashboardSignalListViewController: FavoriteStateChangeProtocol {
...
extension DashboardSignalListViewController: DelegateManagerProtocol {
