...
extension UIAlertController {
    ...
    func addPickerView(values: PickerViewViewController.Values, initialSelection: PickerViewViewController.Index? = nil, height: CGFloat? = 216.0, action: PickerViewViewController.Action?) {
