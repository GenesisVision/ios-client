//
//  FundAssetsTableViewCellViewModel.swift
//  genesisvision-ios
//
...
struct FundAssetsTableViewCellViewModel {
    let fundAssetInfo: FundAssetInfo
}

extension FundAssetsTableViewCellViewModel: CellViewModel {
    func setup(on cell: FundAssetsTableViewCell) {
