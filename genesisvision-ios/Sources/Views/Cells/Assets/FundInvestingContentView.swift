//
//  FundInvestingContentView.swift
//  genesisvision-ios
//
...
class FundInvestingContentView: UIStackView {
    // MARK: - Variables
...
extension FundInvestingContentView: ContentViewProtocol {
    /// FundInvesting
    /// - Parameters:
...
extension FundInvestingContentView {
    /// Fund assets
