...
//    func setupCellSize(text: String, photo: Bool) {
//        textView.text = text
//
//        let photoHeight = photo ? CGFloat(200) : CGFloat(0)
//        let textHeight = text.height(forConstrainedWidth: UIScreen.main.bounds.width - 20, font: UIFont.getFont(.regular, size: 16))*1.5
//
//        if let middleViewHeightConstraint = middleViewHeightConstraint {
//            NSLayoutConstraint.deactivate([middleViewHeightConstraint])
//            middleViewHeightConstraint.constant = textHeight > limitTextHeight ? limitTextHeight + photoHeight : textHeight + photoHeight
//            NSLayoutConstraint.activate([middleViewHeightConstraint])
//        }
//    }
...
//final class SocialPostContentView: UIView {
//
//    let textView: UITextView = {
//        let textView = UITextView()
//        textView.translatesAutoresizingMaskIntoConstraints = false
