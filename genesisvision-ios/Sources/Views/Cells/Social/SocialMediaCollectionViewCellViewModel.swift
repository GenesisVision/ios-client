...
class SocialMediaCollectionViewCell: UICollectionViewCell {
    ...
    private func overlaySecondLayer() {
        ...
        arrowImageView.anchor(top: topButtonView.topAnchor, leading: nil, bottom: topButtonView.bottomAnchor, trailing: topButtonView.trailingAnchor, padding: UIEdgeInsets(top: 19, left: 0, bottom: 19, right: 10), size: CGSize(width: 12, height: 12))
