...
struct ProgramFacetCollectionViewCellViewModel {
    let facet: ProgramFacet?
    let isFavoriteFacet: Bool
}

extension ProgramFacetCollectionViewCellViewModel: CellViewModel {
...
struct FundFacetCollectionViewCellViewModel {
    let facet: FundFacet?
    let isFavoriteFacet: Bool
}

extension FundFacetCollectionViewCellViewModel: CellViewModel {
    func setup(on cell: FacetCollectionViewCell) {
        if let title = facet?.title {
            cell.titleLabel.text = title
        }
