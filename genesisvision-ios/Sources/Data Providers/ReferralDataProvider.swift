...
class ReferralDataProvider: DataProvider {
    ...
    static func getFriends(dateFrom: Date?, dateTo: Date?, skip: Int, take: Int, completion: @escaping (_ profile: ReferralFriendItemsViewModel?) -> Void, errorCompletion: @escaping CompletionBlock) {
