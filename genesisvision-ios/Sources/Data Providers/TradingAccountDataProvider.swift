//
//  TradingAccountDataProvider.swift
//  genesisvision-ios
//
...
class TradingAccountDataProvider: DataProvider {
    // MARK: - Details
    static func getDetails(with accountId: String, completion: @escaping (_ privateTradingAccountFull: PrivateTradingAccountFull?) -> Void, errorCompletion: @escaping CompletionBlock) {
