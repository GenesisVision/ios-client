...
final class FundDetailsViewModel: TabmanViewModel {
    // MARK: - Variables
    var fundId: String!
    ...
    func setup(_ viewModel: FundDetailsFull? = nil) {
        ...
        if let router = router as? FundDetailsRouter, let fundDetailsFull = fundDetailsFull {
            ...
            //TODO:
//            if let isInvested = fundDetailsFull.personalFundDetails?.isInvested, isInvested, let vc = router.getEvents(with: fundId) {
//                self.addController(vc)
//                self.addItem(vc.viewModel.title)
//            }
