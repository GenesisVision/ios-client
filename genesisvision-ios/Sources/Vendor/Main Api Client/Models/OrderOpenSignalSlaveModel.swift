//
// OrderOpenSignalSlaveModel.swift
//
...
open class OrderOpenSignalSlaveModel: Codable {
    ...
    public init(manager: ProfilePublic?, program: OrderProgramData?, programId: UUID?, id: UUID?, login: String?, ticket: String?, symbol: String?, volume: Double?, profit: Double?, direction: Direction?, date: Date?, price: Double?, priceCurrent: Double?, entry: Entry?) {
