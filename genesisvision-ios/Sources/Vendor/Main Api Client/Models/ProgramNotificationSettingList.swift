...
open class ProgramNotificationSettingList: Codable {
    ...
    public init(level: Int?, settingsCustom: [NotificationSettingViewModel]?, assetId: UUID?, title: String?, url: String?, logo: String?, color: String?, settingsGeneral: [NotificationSettingViewModel]?) {
        self.level = level
