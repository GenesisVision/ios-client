...
open class RegisterViewModel: Codable {
    ...
    public init(password: String, confirmPassword: String?, userName: String?, refCode: String?, isAuto: Bool?, email: String, captchaCheckResult: CaptchaCheckResult?) {
