...
open class ManagerOpenTrades: Codable {
    ...
    public init(managerAccountId: UUID, trades: [OpenOrderModel]) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        trades = try container.decode([OpenOrderModel].self, forKey: "trades")
    }
}
