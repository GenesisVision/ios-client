...
open class WalletData: Codable {
    ...
    public init(id: UUID?, title: String?, logo: String?, address: String?, rateToGVT: Double?, currency: Currency?, available: Double?, invested: Double?, pending: Double?, total: Double?, currencyCcy: CurrencyCcy?, availableCcy: Double?, investedCcy: Double?, pendingCcy: Double?, totalCcy: Double?) {
        self.id = id
        self.title = title
        self.logo = logo
