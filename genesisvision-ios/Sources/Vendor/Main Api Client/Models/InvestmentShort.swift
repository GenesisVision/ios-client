...
open class InvestmentShort: Codable {
    ...
    public init(id: UUID?, managerAccountId: UUID?, managerTokensId: UUID?, logo: String?, description: String?, title: String?, isEnabled: Bool?, rating: Double?, ordersCount: Int?, totalProfit: Double?) {
        self.id = id
