...
open class PersonalProgramDetailsFull: Codable {
    ...
    public init(isReinvest: Bool?, isFavorite: Bool?, isInvested: Bool?, isOwnProgram: Bool?, canInvest: Bool?, canWithdraw: Bool?, value: Double?, profit: Double?, status: Status?) {
