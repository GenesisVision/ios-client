...
open class FundDetailsListItem: Codable {
    ...
    public init(id: UUID?, logo: String?, url: String?, color: String?, title: String?, description: String?, creationDate: Date?, investorsCount: Int?, status: String?, totalAssetsCount: Int?, topFundAssets: [FundAssetPercent]?, owner: ProfilePublicShort?, statistic: ProfitChart?, personalDetails: PersonalFundDetailsList?, balance: AmountWithCurrency?) {
        self.id = id
        self.logo = logo
        self.url = url
        self.color = color
