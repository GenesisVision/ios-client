...
open class InvestorAPI {
  ...
  "availableToWithdraw" : 6.027456183070403
     ...
     * enum for parameter currency
     */
    public enum Currency_v10InvestorFundsGet: String { 
        case undefined = "Undefined"
        case gvt = "GVT"
        case eth = "ETH"
        case btc = "BTC"
     ...
     */
    public enum DashboardActionStatus_v10InvestorFundsGet: String { 
        case all = "All"
        case active = "Active"
    }
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func v10InvestorFundsGet(authorization: String, sorting: Sorting_v10InvestorFundsGet? = nil, currency: Currency_v10InvestorFundsGet? = nil, from: Date? = nil, to: Date? = nil, chartPointsCount: Int? = nil, currencySecondary: CurrencySecondary_v10InvestorFundsGet? = nil, actionStatus: ActionStatus_v10InvestorFundsGet? = nil, dashboardActionStatus: DashboardActionStatus_v10InvestorFundsGet? = nil, skip: Int? = nil, take: Int? = nil, completion: @escaping ((_ data: FundsList?,_ error: Error?) -> Void)) {
        v10InvestorFundsGetWithRequestBuilder(authorization: authorization, sorting: sorting, currency: currency, from: from, to: to, chartPointsCount: chartPointsCount, currencySecondary: currencySecondary, actionStatus: actionStatus, dashboardActionStatus: dashboardActionStatus, skip: skip, take: take).execute { (response, error) -> Void in
            completion(response?.body, error);
        }
    }
  ...
  "funds" : [ {
     ...
     */
    open class func v10InvestorFundsGetWithRequestBuilder(authorization: String, sorting: Sorting_v10InvestorFundsGet? = nil, currency: Currency_v10InvestorFundsGet? = nil, from: Date? = nil, to: Date? = nil, chartPointsCount: Int? = nil, currencySecondary: CurrencySecondary_v10InvestorFundsGet? = nil, actionStatus: ActionStatus_v10InvestorFundsGet? = nil, dashboardActionStatus: DashboardActionStatus_v10InvestorFundsGet? = nil, skip: Int? = nil, take: Int? = nil) -> RequestBuilder<FundsList> {
  ...
  "chart" : {
    ...
    "changeValueCurrency" : 1.2315135367772556,
    "valueCurrency" : 2.027123023002322,
    "balanceChart" : [ {
      "date" : "2000-01-23T04:56:07.000+00:00",
      "value" : 0.8008281904610115
    }, {
    ...
    "changePercent" : 4.145608029883936,
    "changeValue" : 7.386281948385884,
  ...
  "events" : {
    ...
    "events" : [ {
      ...
      "color" : "color",
      "description" : "description",
      "feeSuccessManager" : 7.457744773683766,
      "title" : "title",
      "type" : "All",
      "url" : "url",
      "feeSuccessPlatform" : 1.1730742509559433,
      "assetType" : "Program",
     ...
     */
    public enum EventLocation_v10InvestorInvestmentsEventsGet: String { 
        case asset = "Asset"
     ...
     */
    public enum EventType_v10InvestorInvestmentsEventsGet: String { 
        case all = "All"
     ...
     */
    public enum AssetType_v10InvestorInvestmentsEventsGet: String { 
        case all = "All"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func v10InvestorInvestmentsEventsGet(authorization: String, eventLocation: EventLocation_v10InvestorInvestmentsEventsGet? = nil, assetId: UUID? = nil, from: Date? = nil, to: Date? = nil, eventType: EventType_v10InvestorInvestmentsEventsGet? = nil, assetType: AssetType_v10InvestorInvestmentsEventsGet? = nil, skip: Int? = nil, take: Int? = nil, completion: @escaping ((_ data: InvestmentEventViewModels?,_ error: Error?) -> Void)) {
        v10InvestorInvestmentsEventsGetWithRequestBuilder(authorization: authorization, eventLocation: eventLocation, assetId: assetId, from: from, to: to, eventType: eventType, assetType: assetType, skip: skip, take: take).execute { (response, error) -> Void in
            completion(response?.body, error);
        }
    }
  ...
  "events" : [ {
     ...
     */
    open class func v10InvestorInvestmentsEventsGetWithRequestBuilder(authorization: String, eventLocation: EventLocation_v10InvestorInvestmentsEventsGet? = nil, assetId: UUID? = nil, from: Date? = nil, to: Date? = nil, eventType: EventType_v10InvestorInvestmentsEventsGet? = nil, assetType: AssetType_v10InvestorInvestmentsEventsGet? = nil, skip: Int? = nil, take: Int? = nil) -> RequestBuilder<InvestmentEventViewModels> {
        let path = "/v1.0/investor/investments/events"
        let URLString = SwaggerClientAPI.basePath + path
        let parameters: [String:Any]? = nil
  ...
  "availableToWithdraw" : 0.8008281904610115
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func v10InvestorProgramsByIdWithdrawMultiByAmountPost(id: UUID, amount: Double, authorization: String, withdrawAll: Bool? = nil, completion: @escaping ((_ error: Error?) -> Void)) {
        v10InvestorProgramsByIdWithdrawMultiByAmountPostWithRequestBuilder(id: id, amount: amount, authorization: authorization, withdrawAll: withdrawAll).execute { (response, error) -> Void in
            completion(error);
        }
    }
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func v10InvestorProgramsByIdWithdrawMultiByAmountPostWithRequestBuilder(id: UUID, amount: Double, authorization: String, withdrawAll: Bool? = nil) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func v10InvestorProgramsByIdWithdrawMultiPost(id: UUID, authorization: String, amount: Double? = nil, withdrawAll: Bool? = nil, completion: @escaping ((_ error: Error?) -> Void)) {
        v10InvestorProgramsByIdWithdrawMultiPostWithRequestBuilder(id: id, authorization: authorization, amount: amount, withdrawAll: withdrawAll).execute { (response, error) -> Void in
            completion(error);
        }
    }
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func v10InvestorProgramsByIdWithdrawMultiPostWithRequestBuilder(id: UUID, authorization: String, amount: Double? = nil, withdrawAll: Bool? = nil) -> RequestBuilder<Void> {
        var path = "/v1.0/investor/programs/{id}/withdraw/multi"
        path = path.replacingOccurrences(of: "{id}", with: "\(id)", options: .literal, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
        let parameters: [String:Any]? = nil
     ...
     * enum for parameter dashboardActionStatus
     */
    public enum DashboardActionStatus_v10InvestorProgramsGet: String { 
        case all = "All"
        case active = "Active"
    }
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func v10InvestorProgramsGet(authorization: String, sorting: Sorting_v10InvestorProgramsGet? = nil, from: Date? = nil, to: Date? = nil, chartPointsCount: Int? = nil, currencySecondary: CurrencySecondary_v10InvestorProgramsGet? = nil, actionStatus: ActionStatus_v10InvestorProgramsGet? = nil, dashboardActionStatus: DashboardActionStatus_v10InvestorProgramsGet? = nil, skip: Int? = nil, take: Int? = nil, completion: @escaping ((_ data: ProgramsList?,_ error: Error?) -> Void)) {
        v10InvestorProgramsGetWithRequestBuilder(authorization: authorization, sorting: sorting, from: from, to: to, chartPointsCount: chartPointsCount, currencySecondary: currencySecondary, actionStatus: actionStatus, dashboardActionStatus: dashboardActionStatus, skip: skip, take: take).execute { (response, error) -> Void in
            completion(response?.body, error);
        }
    }
  ...
  "requests" : [ {
     ...
     * enum for parameter dashboardActionStatus
     */
    public enum DashboardActionStatus_v10InvestorSignalsGet: String { 
        case all = "All"
        case active = "Active"
    }
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func v10InvestorSignalsGet(authorization: String, sorting: Sorting_v10InvestorSignalsGet? = nil, from: Date? = nil, to: Date? = nil, chartPointsCount: Int? = nil, currencySecondary: CurrencySecondary_v10InvestorSignalsGet? = nil, actionStatus: ActionStatus_v10InvestorSignalsGet? = nil, dashboardActionStatus: DashboardActionStatus_v10InvestorSignalsGet? = nil, skip: Int? = nil, take: Int? = nil, completion: @escaping ((_ data: SignalsList?,_ error: Error?) -> Void)) {
        v10InvestorSignalsGetWithRequestBuilder(authorization: authorization, sorting: sorting, from: from, to: to, chartPointsCount: chartPointsCount, currencySecondary: currencySecondary, actionStatus: actionStatus, dashboardActionStatus: dashboardActionStatus, skip: skip, take: take).execute { (response, error) -> Void in
            completion(response?.body, error);
        }
    }
  ...
  "programs" : [ {
    ...
    "personalDetails" : {
      ...
      "signalSettingsId" : "046b6c7f-0b8a-43b9-b35d-6489e6daee91",
      "signalSubscription" : {
        "mode" : "ByBalance",
        "totalVolume" : 2.3021358869347655,
        "hasSignalAccount" : true,
    ...
    "levelProgress" : 2.027123023002322,
    "status" : "None"
  }, {
    "color" : "color",
    "manager" : {
