...
open class TweePlaceholderTextField: UITextField {
	...
	@IBInspectable public var originalPlaceholderFontSize: CGFloat = 18
	/// Placeholder animation duration.
	@IBInspectable public var placeholderDuration: Double = 0.3
	...
	private func initializeSetup() {
        ...
        placeholderColor = UIColor.Cell.subtitle
        textAlignment = .left
	}
